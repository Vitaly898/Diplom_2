...
public class GetListOfIngredientsTest {
    ...
    public void getListOfOrdersWithoutAuthorization(){
        ...
        token = "";
        ValidatableResponse response = UserClient.getInfoAboutUser(token);
        response
    ...
    public void getListOfOrdersWithAuthorization(){
        ...
        ValidatableResponse createOrderForTest = OrderClient.createOrder(order);
        ValidatableResponse getInfoAboutUser = UserClient.getInfoAboutUser(token);
